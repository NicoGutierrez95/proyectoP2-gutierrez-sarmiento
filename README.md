...
El registro manual en papel implica:

- Pérdida de tiempo en el volcado de datos.
- Riesgo de errores de transcripción.
- Dificultad para realizar seguimiento en tiempo real.
- Dependencia de cargas manuales semanales al sistema SINIDE.

## Objetivo

Digitalizar y centralizar el registro de asistencia, habilitando:

- Control en tiempo real.
- Alertas automáticas por límite de inasistencias y asistencia perfecta.
- Generación de reportes consolidados (Excel).
- Seguimiento completo del historial de cada alumno por ciclo lectivo.
...
- **RF1** — Administración del sistema (ciclo lectivo, usuarios, cursos, alumnos).
- **RF2** — Registro de asistencia (flujos para teóricas, taller y educación física).
- **RF3** — Estados de asistencia.
- **RF4** — Sistema de contadores (por área, general, tardanzas y justificaciones).
- **RF5** — Gestión de faltas justificadas con notificación cruzada.
- **RF6** — Alertas automáticas (límite, seguimiento, asistencia perfecta).
- **RF7** — Reportes y estadísticas exportables en Excel.
...
## Tecnologías (a definir por el equipo)
